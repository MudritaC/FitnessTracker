...
public class PedometerActivity extends AppCompatActivity implements SensorEventListener, StepListner {

    private TextView tvCalories,tvSteps;
    private StepDetector simpleStepDetector;
    private SensorManager sensorManager;
    private Sensor accel;
    private static final String TEXT_NUM_STEPS = "Number of Steps: ";
    private static final String TEXT_CALORIES = "Total Calories burnt: ";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvCalories.setText(TEXT_CALORIES + numSteps*0.04);
